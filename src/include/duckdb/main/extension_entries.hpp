...
static constexpr ExtensionFunctionEntry EXTENSION_FUNCTIONS[] = {
    ...
    {"array_all", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"array_any", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    ...
    {"list_all", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
    {"list_any", "core_functions", CatalogType::SCALAR_FUNCTION_ENTRY},
